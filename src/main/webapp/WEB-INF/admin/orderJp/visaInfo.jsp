...
//			财产验证
		...
		function save(status){
			...
			$.ajax({
				...
				async: false,
				data : passportInfo,
				url: '${base}/admin/orderJp/saveEditVisa.html',
				success :function(data) {
					...
					if(status == 1){
						...
						socket.onclose();
						window.location.href = '/admin/orderJp/passportInfo.html?applicantId='+applicantId+'&orderid='+orderid+'&isTrial='+isTrail+'&orderProcessType='+orderProcessType+'&addApply='+addApply+'&tourist='+tourist;
					}
				}
			});
		}
