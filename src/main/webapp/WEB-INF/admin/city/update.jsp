...
<body>
					...
					<input name="id" type="hidden" value="${obj.id}">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input id="country" name="country" value="${obj.country}" type="text" class="form-control input-sm" placeholder=" " />
									</div>
								</div>
	...
	<script type="text/javascript">
		...
		function save() {
			$('#cityUpdateForm').bootstrapValidator('validate');
			var bootstrapValidator = $("#cityUpdateForm").data('bootstrapValidator');
