...
<body>
									...
									<div class="form-group">
										...
										<input id="name" name="name" type="text" class="form-control input-sm" placeholder=" " />
											...
											<div class="form-group">
												...
												<input id="namejp" name="namejp" type="text" class="form-control input-sm" placeholder=" " />
											</div>
										</div>
																																																																																																																														</div>
									...
									<div class="form-group">
										...
										<input id="address" name="address" type="text" class="form-control input-sm" placeholder=" " />
											...
											<div class="form-group">
												...
												<input id="addressjp" name="addressjp" type="text" class="form-control input-sm" placeholder=" " />
											</div>
										</div>
																																																																																												</div>
									...
									<div class="form-group">
										...
										<input id="mobile" name="mobile" type="text" class="form-control input-sm" placeholder=" " />
											...
											<div class="form-group">
												...
												<input id="cityId" name="cityId" type="text" class="form-control input-sm" placeholder=" " />
											</div>
										</div>
																																																										</div>
	...
	<script type="text/javascript">
		...
		function save() {
			...
			//得到获取validator对象或实例 
			var bootstrapValidator = $("#hotelAddForm").data('bootstrapValidator');
			// 执行表单验证 
