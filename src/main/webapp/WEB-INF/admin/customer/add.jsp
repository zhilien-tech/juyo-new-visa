				...
				<div class="tab-content">
									...
									<div class="form-group">
										...
										<input id="userId" name="userId" type="text" class="form-control input-sm" placeholder=" " />
											...
											<div class="form-group">
												...
												<input id="compId" name="compId" type="text" class="form-control input-sm" placeholder=" " />
											</div>
										</div>
																																																																																																																																																																</div>
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input id="source" name="source" type="text" class="form-control input-sm" placeholder=" " />
									</div>
								</div>
