...
<html lang="en-US">
	...
	<body class="hold-transition skin-blue sidebar-mini">
		...
		new Vue({
			...
			created:function(){
		        orderobj=this;
		        var url = '${base}/admin/orderUS/getVisaInfoData.html';
		        $.ajax({ 
		        	url: url,
		        	dataType:"json",
		    ...
		    methods:{
		    	...
		    	edit:function(visainputid){
		    	      window.location.href = '${base}/admin/orderUS/visaInputUpdate.html?id='+visainputid+'&orderid='+orderid;
		    	},
		    	deleteVisainput:function(visainputid){
					...
					$.ajax({ 
				    	url: '/admin/orderUS/deleteVisainput',
				    	dataType:"json",
				    	data:{id:visainputid},
				    	type:'post',
				    	success: function(data){
		...
		//新增签证录入
		function add(){
			window.location.href = '${base}/admin/orderUS/visaInputAdd.html?staffid='+staffid+'&orderid='+orderid;
		 }
