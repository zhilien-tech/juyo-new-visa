				...
				<div class="tab-content">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input id="parentId" name="parentId" type="text" class="form-control input-sm" placeholder=" " />
									</div>
								</div>
											...
											<div class="form-group">
												...
												<input id="funName" name="funName" type="text" class="form-control input-sm" placeholder=" " />
											</div>
										</div>
																																																																																																																																															</div>
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input id="url" name="url" type="text" class="form-control input-sm" placeholder=" " />
									</div>
								</div>
											...
											<div class="form-group">
												...
												<input id="level" name="level" type="text" class="form-control input-sm" placeholder=" " />
											</div>
										</div>
																																																																																																													</div>
									...
									<div class="form-group">
										...
										<input id="remark" name="remark" type="text" class="form-control input-sm" placeholder=" " />
											...
											<div class="form-group">
												...
												<input id="sort" name="sort" type="text" class="form-control input-sm" placeholder=" " />
											</div>
										</div>
																																									</div>
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<input id="portrait" name="portrait" type="text" class="form-control input-sm" placeholder=" " />
									</div>
								</div>
