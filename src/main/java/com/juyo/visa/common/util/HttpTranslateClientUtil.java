 ...
 */
public class HttpTranslateClientUtil {
	...
	public static void setHttpclient(HttpClient httpclient) {
		HttpTranslateClientUtil.httpclient = httpclient;
	}
	...
	public static void setMaxTotal(int maxTotal) {
		HttpTranslateClientUtil.maxTotal = maxTotal;
	}
	...
	public static void setMaxPerRoute(int maxPerRoute) {
		HttpTranslateClientUtil.maxPerRoute = maxPerRoute;
	}
	...
	public static void setUserAgent(String userAgent) {
		HttpTranslateClientUtil.userAgent = userAgent;
	}
}
