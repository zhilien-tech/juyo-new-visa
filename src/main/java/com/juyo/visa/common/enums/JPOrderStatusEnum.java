...
public enum JPOrderStatusEnum implements IEnum {
	PLACE_ORDER(1, "下单"), SHARE(2, "分享"), FILLING_INFORMATION(3, "填写资料"), FILLED_INFORMATION(4, "填写完成"), FIRSTTRIAL_ORDER(
			...
			13, "签证"), VISA_RECEIVED(14, "签证实收"), AUTO_FILL_FORM_PREPARE(15, "准备发招宝"), AUTO_FILL_FORM_ING(16, "发招宝中"), READYCOMMING(
			28, "准备提交大使馆"), COMMITING(32, "提交中"), COMMINGFAIL(31, "提交失败"), AUTO_FILL_FORM_ED(17, "已发招宝"), AUTO_FILL_FORM_FAILED(
			...
			25, "售后"), DISABLED(26, "作废"), JAPANREPORT(29, "归国报告"), JAPANREPORTFAIL(30, "归国报告失败"), CHANGE_PRINCIPAL_OF_ORDER(
			88, "负责人变更");
	private int key;
