...
public enum JpOrderSimpleEnum implements IEnum {
	PLACE_ORDER(1, "下单"), VISA_RECEIVED(14, "签证实收"), AUTO_FILL_FORM_PREPARE(15, "准备发招宝"), AUTO_FILL_FORM_ING(16, "发招宝中"), READYCOMMING(
			...
			25, "售后"), CAN_BACKMAIL(33, "可以回邮"), DISABLED(26, "作废"), JAPANREPORT(29, "归国报告"), JAPANREPORTFAIL(30,
			"归国报告失败");
	private int key;
