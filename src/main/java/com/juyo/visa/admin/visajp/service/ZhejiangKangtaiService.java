 ...
 */
@IocBean
public class ZhejiangKangtaiService extends BaseService<TOrderJpEntity> {
	...
	private ByteArrayOutputStream note(Map<String, Object> tempdata) {
		...
		content.append("　　" + companyname).append("(").append(cdesignnum).append(")根据与").append(dijie).append("(番号:")
				...
				.append(" 人访日旅游，请协助办理").append(visatypestr).append("赴日签证。");
		...
		//获取模板文件
		URL resource = getClass().getClassLoader().getResource("japanfile/zhejiangkangtai/note.pdf");
		TemplateUtil templateUtil = new TemplateUtil();
