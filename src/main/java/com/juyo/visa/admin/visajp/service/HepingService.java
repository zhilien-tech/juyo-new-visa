 ...
 */
@IocBean
public class HepingService extends BaseService<TOrderJpEntity> {
	...
	private ByteArrayOutputStream note(Map<String, Object> tempdata) {
		...
		content.append(companyname).append("根据与").append(dijie).append("的合同约定，组织").append(applyinfo.size())
				.append("人赴日个人旅游，请协助办理").append(visatypestr).append("赴日签证。");
		...
		//获取模板文件
		URL resource = getClass().getClassLoader().getResource("japanfile/heping/note.pdf");
		TemplateUtil templateUtil = new TemplateUtil();
